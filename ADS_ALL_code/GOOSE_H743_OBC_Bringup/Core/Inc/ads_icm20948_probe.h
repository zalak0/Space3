...
typedef enum
{
    ADS_ICM20948_MAG_NOT_RUN = 0,
    ADS_ICM20948_MAG_OK = 1,
    ADS_ICM20948_MAG_HAL_ERROR = 2,
    ADS_ICM20948_MAG_BAD_ARG = 3,
    ADS_ICM20948_MAG_BAD_WHOAMI = 4,
    ADS_ICM20948_MAG_DATA_NOT_READY = 5
} ADS_ICM20948_MagResult;
...
typedef struct
{
    ADS_ICM20948_MagResult result;
    uint8_t icm_address_7bit;

    uint8_t ak09916_wia1;
    uint8_t ak09916_wia2;
