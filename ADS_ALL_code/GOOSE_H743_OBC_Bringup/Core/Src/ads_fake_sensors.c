...
static Vector3 s_accel_body_m_s2;
...
static void ADS_FakeSensors_SetAllValid(void)
{
    ...
    s_fake_status.accel_valid = 1u;
    s_fake_status.sun_valid = 0u;
...
void ADS_FakeSensors_Init(void)
{
    ...
    s_accel_body_m_s2 = make_vector3(0.0f, 0.0f, 9.80665f);

    s_sun_body = make_vector3(0.0f, 0.0f, 0.0f);
